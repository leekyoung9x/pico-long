...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isNangLuongBill) {
            sendItemTime(player, 4847, (int) ((TEN_MINUTES - (System.currentTimeMillis() - player.itemTime.lastTimeNangLuongBill)) / 1000));
        }
        ...
        if (player.itemTime.rateDame) {
            sendItemTime(player, 30595, (int) ((ONE_HOUR - (System.currentTimeMillis() - player.itemTime.lastTimeDameDr)) / 1000));
        }
        if (player.itemTime.item212x2) {
            sendItemTime(player, 30595, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeitem212x2)) / 1000));
        }
        ...
        if (player.itemTime.rateBoneDrTNSM) {
            sendItemTime(player, 7337, (int) ((THIRTY_MINUTES - (System.currentTimeMillis() - player.itemTime.lastTimeTNSMBoneDr)) / 1000));
        }
        if (player.itemTime.rateNoelDrSucDanhHPKI) {
            sendItemTime(player, 8579, (int) ((TEN_MINUTES - (System.currentTimeMillis() - player.itemTime.lastTimeSucDanhHPKINoelDr)) / 1000));
        }
        if (player.itemTime.rateNoelDrHPKI) {
            sendItemTime(player, 8580, (int) ((THIRTY_MINUTES - (System.currentTimeMillis() - player.itemTime.lastTimeHPKINoelDr)) / 1000));
        }
        if (player.itemTime.rateDameMaXuong) {
            sendItemTime(player, 5105, (int) ((DAME_MAXUONG - (System.currentTimeMillis() - player.itemTime.lastTimeDameMaXuong)) / 1000));
        }
        if (player.itemTime.rateNaoCho) {
            sendItemTime(player, 6980, (int) ((NAO_CHO - (System.currentTimeMillis() - player.itemTime.lastTimeNaoCho)) / 1000));
        }
    }
