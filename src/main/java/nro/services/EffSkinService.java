...
public class EffSkinService {
    ...
    public void setHoaXuong(Player player, long lastTimeHoaGay, int timeHoaGay) {
        player.effectSkin.isHoaXuong = true;
        player.effectSkin.lastTimeHoaXuong = lastTimeHoaGay;
        player.effectSkin.timeHoaXuong = timeHoaGay;
        Service.getInstance().point(player);
    }
    ...
    public void removeHoaGay(Player player) {
        player.effectSkin.isHoaXuong = false;
        Service.getInstance().Send_Caitrang(player);
        Service.getInstance().point(player);
//        sendEffectPlayer(player, player, TURN_OFF_EFFECT, STONE_EFFECT);
    }
