...
public class HttpRequestHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    public JSONObject addRuby(int quantity) {
        int oldRuby = this.player.inventory.ruby;
        this.player.inventory.addRuby(quantity);
        // ekko ghi log add ruby
        Manager.addPlayerRubyHistory(this.player.id, oldRuby, this.player.inventory.ruby, "HttpRequestHandler-addRuby");
