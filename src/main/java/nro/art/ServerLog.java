...
public class ServerLog {
    ...
    public static void logTradeRuby(String name, int quantity) {
        try {
            ...
            String filename = "log/logTrade/Trade_" + dateFormat.format(dt) + ".txt";
    ...
    public static void logRewardRuby1H(String name, int quantity) {
        try {
            Calendar cl = Calendar.getInstance();
            Date dt = cl.getTime();
            String str = toTimeString(Date.from(Instant.now()));
            String filename = "log/reward/ruby_" + dateFormat.format(dt) + ".txt";
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
            bw.write("Player: " + name + "- sl:  " + quantity + "- Time : " + str + "\n");
            bw.close();
    ...
    public static void logSubRuby(String name, int quantity) {
        try {
            ...
            Date dt = cl.getTime();
            String str = toTimeString(Date.from(Instant.now()));
            String filename = "log/subRuby/Sub_" + dateFormat.format(dt) + ".txt";
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
            bw.write("Player: " + name + "- sl:  " + quantity + "- Time : " + str + "\n");
            bw.close();
    ...
    public static void logAchivement(String name, int quantity) {
        try {
            ...
            Date dt = cl.getTime();
            String str = toTimeString(Date.from(Instant.now()));
            String filename = "log/task/Achi_" + dateFormat.format(dt) + ".txt";
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
            bw.write("Player: " + name + "- sl:  " + quantity + "- Time : " + str + "\n");
            bw.close();
    ...
    public static void logDame(String name, long dame) {
        try {
            Calendar cl = Calendar.getInstance();
            Date dt = cl.getTime();
            String str = toTimeString(Date.from(Instant.now()));
            String filename = "log/dame/dame_" + dateFormat.format(dt) + ".txt";
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
            bw.write("Player: " + name + "- sl:  " + Util.numberToMoney(dame) + "- Time : " + str + "\n");
            bw.close();
            fw.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void logAdmin(String name, int quantity) {
        try {
            ...
            Date dt = cl.getTime();
            String str = toTimeString(Date.from(Instant.now()));
            String filename = "log/admin/AD_" + dateFormat.format(dt) + ".txt";
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
            bw.write("Player: " + name + "- sl:  " + quantity + "- Time : " + str + "\n");
            bw.close();
    ...
    public static void logRewardDay(String name, String item, int quantity) {
        try {
            ...
            String str = toTimeString(Date.from(Instant.now()));
            String filename = "log/logDay/rewand_" + dateFormat.format(date) + ".txt";
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
    ...
    public static void logCombine(String name, String itemname, int param) {
        try {
            ...
            Date date = calender.getTime();
            String str = toTimeString(Date.from(Instant.now()));
            String filename = "log/log/Combine_" + dateFormat.format(date) + ".txt";
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
    ...
    public static void logItemDrop(String name, String item) {
        try {
            ...
            Date date = calender.getTime();
            String str = toTimeString(Date.from(Instant.now()));
            String filename = "log/log/ItemDrop_" + dateFormat.format(date) + ".txt";
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
