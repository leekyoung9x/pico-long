...
//        this.timeUpdateActive = 250;
    ...
    public void rewards(Player plKill) {
        ...
        for (int i = 0; i < 2; i++) {
            ItemMap item = new ItemMap(this.zone, ConstItem.BINH_NUOC, 1, (plKill.isPet ? ((Pet) plKill).master.location.x : plKill.location.x) + Util.nextInt(-20, 20), this.zone.map.yPhysicInTop(this.location.x,
