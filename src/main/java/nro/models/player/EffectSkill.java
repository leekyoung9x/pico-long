...
public class EffectSkill {
    ...
    public boolean isMaPhongBe;
    public long lastTimeMaPhongBe;
    public int timeMaPhongBe;

    public boolean isBinh;
    public boolean isBinh2;
...
//    public int timeAnTroi;
    ...
    public void update() {
        ...
        if (isMaPhongBe && (Util.canDoWithTime(lastTimeMaPhongBe, timeMaPhongBe))) {
            EffectSkillService.gI().removeSocola(this.player);
        }
