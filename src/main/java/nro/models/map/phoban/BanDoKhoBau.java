...
public class BanDoKhoBau {
    ...
    public static final long POWER_CAN_GO_TO_DBKB = 2_000_000_000;

    public static final List<BanDoKhoBau> BAN_DO_KHO_BAUS;
    public static final int MAX_AVAILABLE = 126;
    ...
    public void openBanDoKhoBau(Player plOpen, Clan clan, byte level) {
        EventTurnManager.ManageCallDragon(ConstAction.UPDATE_BY_ID, plOpen.id);
        this.level = level;
