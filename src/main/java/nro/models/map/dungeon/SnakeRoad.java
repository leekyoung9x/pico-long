...
//                int sl = 5;
//                for (int i = 0; i < sl; i++) {
//                    ItemMap carot = new ItemMap(r, 459, 1, 10 * i + 530, 312, -1);
//                    Service.getInstance().dropItemMap(r, carot);
//
//                }
//            } else {
//                int sl = 5;
//                for (int i = 0; i < sl; i++) {
//                    ItemMap ngocrong = new ItemMap(r, 16, 1, 10 * i + 530, 312, -1);
//                    Service.getInstance().dropItemMap(r, ngocrong);
//                }
//            }

//                ItemMap item = new ItemMap(r, 459, 5, 530, 312, -1);
