 ...
 * @author Arriety
 */
public class ngok extends Npc {

    public ngok(int mapId, int status, int cx, int cy, int tempId, int avartar) {
...
//                                break;
                            case 0:
                                ...
                                LocalTime end = LocalTime.of(22, 59, 59); // 22:59:59
                                if (now.isBefore(start) || now.isAfter(end)) {
                                    Service.gI().sendThongBao(player, "Ngũ hành sơn sẽ mở vào 17h mỗi ngày ");
                ...
                case 122:
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0: // shop bùa
                                // ekko
//                                Item i2 = InventoryService.gI().findItemBagByTemp(player, 542);
//                                if (i2 == null) {
//                                    this.npcChat(player, "Bạn không đủ quả đào chín");
//                                    return;
//                                }
////                                if (i2.quantity <= 99) {
...
////
////                                }
//                                Item thoivip = ItemService.gI().createNewItem((short) 2135, 1);
//
//                                thoivip.itemOptions.add(new ItemOption(50, 35));
//                                thoivip.itemOptions.add(new ItemOption(77, 35));
//                                thoivip.itemOptions.add(new ItemOption(103, 35));
//                                thoivip.itemOptions.add(new ItemOption(42, 10));
//                                if (Util.isTrue(98, 100)) {
//                                    thoivip.itemOptions.add(new ItemOption(93, 1));
//                                }
//                                InventoryService.gI().subQuantityItemsBag(player, i2, 1);
//                                int randomPoints = Util.nextInt(5, 10);
//                                player.diem_skien += randomPoints;
////                                    player.diem_skien ++;
//                                InventoryService.gI().addItemBag(player, thoivip, 9999);
//                                InventoryService.gI().sendItemBags(player);
//                                this.npcChat(player, "Đổi quả đào chín thành công, điểm sự kiện của bạn là " + player.diem_skien);
//                                Service.gI().sendThongBao(player, "Bạn nhận được linh thú tôn hành giả ");
                                break;
//                            case 1:
//                                CombineServiceNew.gI().openTabCombine(player,
