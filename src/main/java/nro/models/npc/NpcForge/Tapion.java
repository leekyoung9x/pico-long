...
//                                    return;
//                                }
//                                Item phaobong = InventoryService.gI().findItemBagByTemp(player, 2086);
//                                if (phaobong == null) {
//                                    Service.getInstance().sendThongBao(player,
//                                            "Bạn không có pháo bông để vào phó bản");
//                                    return;
//                                }
//                                if (phaobong.quantity < 20) {
//                                    Service.getInstance().sendThongBao(player,
//                                            "Bạn thiếu x20 pháo bông để vào phó bản");
//                                    return;
//                                }
//                                InventoryService.gI().subQuantityItemsBag(player, phaobong, 20);
